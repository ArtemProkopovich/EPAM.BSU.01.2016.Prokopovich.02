...
namespace Task2_NUnitTest
{
    ...
    class GCDSteinTest
    {
        ...
        public int GCDSteinEvulationTest(int num1, int num2)
        {
            return Gcd.Stein(num1, num2);
        }

        [Test, TestCase(10240, 1000, 60, Result = 20)]
        public int GCDSteinEvulationTest(int num1, int num2, int num3)
        {
            return Gcd.Stein(num1, num2, num3);
        }

        [Test, TestCase(10240, 1000, 60, 10, Result = 10)]
        public int GCDSteinEvulationTest(params int[] array)
        {
            return Gcd.Stein(array);
        }
